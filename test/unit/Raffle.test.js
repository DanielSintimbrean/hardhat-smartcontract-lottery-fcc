...
!developmentChains.includes(network.name)
    ...
    : describe("Raffle Unit Tests", function () {
          let raffle, vrfCoordinatiorV2Mock, raffleEntranceFee, deployer, interval
          ...
          beforeEach(async function () {
              ...
              vrfCoordinatiorV2Mock = await ethers.getContract("VRFCoordinatorV2Mock", deployer)
          ...
          describe("contructor", function () {
              it("initializes the raffle correctly", async function () {
                  const raffleStates = await raffle.getRaffleState()
                  assert.equal(raffleStates.toString(), "0")
          ...
          describe("enterRaffle", function () {
              ...
              it("doesnt allow entrance when raffle is caculating", async function () {
                  await raffle.enterRaffle({ value: raffleEntranceFee })
          ...
          describe("performUpkeep", function () {
              it("it con only run if checkupkeep is true", async function () {
                  await raffle.enterRaffle({ value: raffleEntranceFee })
                  await network.provider.send("evm_increaseTime", [interval.toNumber() + 1])
                  await network.provider.send("evm_mine", [])
          ...
          describe("fulfillRandomWords", function () {
              ...
              it("can only be called after performUpkeep", async function () {
                  await expect(
                      vrfCoordinatiorV2Mock.fulfillRandomWords(0, raffle.address)
                  ).to.be.revertedWith("nonexistent request")
                  await expect(
                      vrfCoordinatiorV2Mock.fulfillRandomWords(1, raffle.address)
                  ).to.be.revertedWith("nonexistent request")
              })
              ...
              it("picks a winner, resets the lottery, and sends money", async function () {
                  ...
                  await new Promise(async (resolve, resject) => {
                      ...
                      await vrfCoordinatiorV2Mock.fulfillRandomWords(
